    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin_post_update', $row_data->id) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div>
                                            <img src="{{ asset('uploads/' . $row_data->banner) }}" alt=""
                                                class="w_200" height="200">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <select name="post_category_id" class="form-control select2">
                                            @foreach ($post_categories as $item)
                                                <option value="{{ $item->id }}"
                                                    @if ($item->id == $row_data->post_category_id) selected @endif>
                                                    {{ $item->category_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="show_comment" class="form-control select2">
                                            <option value="Yes" @if ($row_data->show_comment == 'Yes') selected @endif>Yes
                                            </option>
                                            <option value="No" @if ($row_data->show_comment == 'No') selected @endif>No
                                            </option>
                                        </select>
                                    </div>
                                    <div class="mb-4">
